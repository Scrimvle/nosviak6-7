...
// EditAllAddConns will forcefully add onto the conns of all users inside the scope.
var EditAllAddConns = commands.EditAll.NewCommand(&cmd.Command{
	Aliases: []string{"add_conns"},
	Description: "increase everyone(s) conns",
