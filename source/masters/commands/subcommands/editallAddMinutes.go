...
var EditAllAddMinutes = commands.EditAll.NewCommand(&cmd.Command{
	Aliases: []string{"add_minutes"},
	Description: "increase everyone(s) minutes",
