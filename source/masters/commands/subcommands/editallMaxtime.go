...
// EditAllMaxtime will forcefully change the maxtime of all users inside the scope.
var EditAllMaxtime = commands.EditAll.NewCommand(&cmd.Command{
	Aliases: []string{"maxtime"},
	Description: "edit everyone(s) expiry",
