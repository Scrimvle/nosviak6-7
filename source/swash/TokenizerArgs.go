...
/*
	...
	certain areas of the source code of a program, these areas include function call & variable declarations (there are
	...
	Another definition for TokenizerArgs.go would be how it's used to parse the array elements within the source code. it
